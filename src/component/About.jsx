...
export const About = (props) => {
    return (
        <div className="accordion p-5" id="accordionExample" style={props.theme2}>
            ...
            <div className="accordion-item" style={props.theme}>
                ...
                <div id="collapseOne"  style={props.theme2} className="accordion-collapse collapse show" data-bs-parent="#accordionExample">
            ...
            <div className="accordion-item"  style={props.theme}>
                ...
                <div id="collapseTwo"  style={props.theme2} className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
            ...
            <div className="accordion-item"  style={props.theme}>
                ...
                <div  style={props.theme2} id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div className="accordion-body">
